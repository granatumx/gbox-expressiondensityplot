!bquote
`gbox-expressiondensityplot` is a gbox that provides a gene plotting in Python by expression level.
!equote
...
$ gx installGbox.sh granatumx/gbox-expressiondensityplot:1.0.0  # Install this gbox
